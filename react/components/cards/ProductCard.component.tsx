...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <div className="bg-[#E4E4E4] rounded-lg py-8 px-6 shadow-md flex flex-col justify-between w-full md:w-[360px] h-auto font-raleway">
      <h3 className="text-xl md:text-2xl">{title}</h3>
      <div className="text-gray-700 flex flex-col justify-between my-4 flex-grow">
        <p>{description1}</p>
