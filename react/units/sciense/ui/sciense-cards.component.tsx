  ...
  return (
    <section className="container max-w-container md:py-10 text-[#FDFDFD] font-raleway ">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 md:space-x-8 md:h-[400px]">
        {/* Левый блок */}
        <div className="font-manrope w-full md:w-1/3 text-primary md:text-[#FDFDFD] md:bg-[#4D4D4E] md:p-5 md:px-10 rounded-2xl h-full">
        ...
        <div className="w-full md:w-2/3 space-y-4 flex flex-col">
          ...
          <div className="bg-[#F3F2F7] text-[#000] py-6 px-6 md:px-10 rounded-2xl flex flex-col space-y-2">
            <h3 className="font-medium text-lg md:text-xl">
